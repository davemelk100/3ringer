...
import { ScheduleState } from '@/lib/types/schedule';
...
describe('scheduleReducer', () => {
  ...
  describe('UPDATE_EVENT', () => {
    ...
    test('should update an existing event', () => {
      ...
      expect(newState.events['Monday-col-1-section-1-0'].content).toBe('Updated Content');
    });
  });
  ...
  describe('DELETE_EVENT', () => {
    test('should remove an event', () => {
      const existingState = {
        ...initialState,
        events: {
          'event-1': { id: 'event-1', content: 'Test Event' },
        },
      };
  ...
  describe('UPDATE_COLUMN', () => {
    test('should update a column', () => {
      const existingState = {
        ...initialState,
        columns: [
          { id: 'col-1', title: 'Old Title', type: 'text' },
        ],
      };
      ...
      const newState = scheduleReducer(existingState, {
        ...
        payload: {
          index: 0,
          column: { id: 'col-1', title: 'New Title', type: 'text' },
        },
      });
  ...
  describe('DELETE_COLUMN', () => {
    test('should delete a column and clean up related data', () => {
      const existingState = {
        ...initialState,
        columns: [
          { id: 'col-1', title: 'Column 1', type: 'dropdown' },
        ],
        events: {
          'Monday-col-1-section-1-0': { content: 'Test' },
        },
        dropdownValues: {
      ...
      expect(newState.dropdownValues['Monday-col-1-section-1-0']).toBeUndefined();
  ...
  describe('REORDER_COLUMNS', () => {
    test('should reorder columns', () => {
      const existingState = {
        ...initialState,
        columns: [
          { id: 'col-1', title: 'Column 1', type: 'text' },
          { id: 'col-2', title: 'Column 2', type: 'text' },
        ],
      };
  ...
  describe('DELETE_ROW', () => {
    test('should delete a row and update related data', () => {
      const existingState = {
        ...
        events: {
          'Monday-col-1-section-1-0': { content: 'Row 0' },
          'Monday-col-1-section-1-1': { content: 'Row 1' },
          'Monday-col-1-section-1-2': { content: 'Row 2' },
        },
        dropdownValues: {
      ...
      expect(newState.sections[0].rows).toBe(1);
      expect(newState.events['Monday-col-1-section-1-1']).toBeUndefined();
      expect(newState.dropdownValues['Monday-col-1-section-1-1']).toBeUndefined();
    });
  });
  ...
  describe('INITIALIZE_COLUMNS', () => {
    test('should initialize columns', () => {
      const columns = [
        { id: 'col-1', title: 'Column 1', type: 'text' },
        { id: 'col-2', title: 'Column 2', type: 'dropdown' },
      ];
